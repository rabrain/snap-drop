<div align="center">
  ...
  # _Send it_, with [SnapDrop](https://www.snap-drop.net)

  <p>
    Local file sharing <a href="https://www.snap-drop.net"><strong>in your web browser</strong></a>. 
    <br>
...
<img src="docs/pairdrop_screenshot_mobile.gif" alt="Screenshot GIF showing SnapDrop in use" style="width: 300px">
...
* Devices outside of your local network that are behind a NAT are auto-connected via the SnapDrop TURN server.
...
* Pairing is persistent. You find your devices even after reopening SnapDrop.
...
* Public rooms are temporary. Closing SnapDrop leaves all rooms.
...
* Warn user before SnapDrop is closed on file transfer
* Open SnapDrop on multiple tabs simultaneously (Thanks [@willstott101](https://github.com/willstott101))
...
* To host SnapDrop on your local network (e.g. on Raspberry Pi): [All peers connected with private IPs are discoverable by each other](https://github.com/RobinLinus/snapdrop/pull/558)
* When hosting SnapDrop yourself, you can [set your own STUN/TURN servers](docs/host-your-own.md#specify-stunturn-servers)
* Translations.

</details>

## Translate SnapDrop on [Hosted Weblate](https://hosted.weblate.org/engage/pairdrop/)
...
## Contributing
Feel free to [open an issue](issues/new/choose) or a
[pull request](pulls), following the
